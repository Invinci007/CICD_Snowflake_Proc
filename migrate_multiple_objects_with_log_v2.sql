...
-- Usage:
-- CALL MIGRATE_MULTIPLE_OBJECTS_WITH_LOG_V2('SOURCE_DB', 'TARGET_DB', 'SOURCE_SCHEMA', 'TARGET_SCHEMA', 'TABLE', 'TABLE1,TABLE2,TABLE3');

CREATE OR REPLACE PROCEDURE MIGRATE_MULTIPLE_OBJECTS_WITH_LOG_V2(
    SOURCE_DATABASE VARCHAR,
    TARGET_DATABASE VARCHAR,
    SOURCE_SCHEMA VARCHAR,
    TARGET_SCHEMA VARCHAR,
...
// Use a regex to correctly parse object names, handling signatures with commas.
var object_list = OBJECT_NAMES.match(/\w+\([^)]*\)|\w+/g) || [];
