-- Snowflake Procedure to Migrate Objects between Databases using JavaScript with Logging (V5)
...
-- Usage:
-- CALL MIGRATE_OBJECT_WITH_LOG_V5('SOURCE_DB', 'TARGET_DB', 'SOURCE_SCHEMA', 'TARGET_SCHEMA', 'TABLE', 'MY_TABLE');

CREATE OR REPLACE PROCEDURE MIGRATE_OBJECT_WITH_LOG_V5(
    SOURCE_DATABASE VARCHAR,
    TARGET_DATABASE VARCHAR,
    SOURCE_SCHEMA VARCHAR,
    TARGET_SCHEMA VARCHAR,
