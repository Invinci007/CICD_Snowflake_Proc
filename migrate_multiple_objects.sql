...
-- Usage:
-- CALL MIGRATE_MULTIPLE_OBJECTS('SOURCE_DB', 'TARGET_DB', 'SOURCE_SCHEMA', 'TARGET_SCHEMA', 'TABLE', 'TABLE1,TABLE2,TABLE3');

CREATE OR REPLACE PROCEDURE MIGRATE_MULTIPLE_OBJECTS(
    SOURCE_DATABASE VARCHAR,
    TARGET_DATABASE VARCHAR,
    SOURCE_SCHEMA VARCHAR,
    TARGET_SCHEMA VARCHAR,
